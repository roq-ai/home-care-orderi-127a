...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order.update': {
    roles: ['home-care-administrator', 'home-care-staff'],
    key: 'order-status-changed',
    tenantPath: ['organization', 'resident', 'order'],
    userPath: [],
  },
  'resident.create': {
    roles: ['home-care-administrator'],
    key: 'new-resident-added',
    tenantPath: ['organization', 'resident'],
    userPath: [],
  },
  'resident.delete': {
    roles: ['home-care-administrator'],
    key: 'resident-removed',
    tenantPath: ['organization', 'resident'],
    userPath: [],
  },
};

const ownerRoles: string[] = ['home-care-administrator'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['home-care-administrator', 'home-care-staff'];
